...
public class AddressTest {
     ...
     */
    public static class AddressComparabilityTest extends ComparabilityTestCase {

        public AddressComparabilityTest(String name) {
            super(name);
        }
    ...
    public static class AddressEqualsHashCodeTest extends EqualsHashCodeTestCase {
        ...
        public AddressEqualsHashCodeTest(String name) {
            super(name);
        }
    ...
    public static class AddressSerializabilityTest extends SerializabilityTestCase {
        ...
        public AddressSerializabilityTest(String name) {
            super(name);
        }
